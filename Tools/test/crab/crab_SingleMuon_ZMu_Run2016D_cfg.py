...
config.General.requestName = 'SingleMuonRun2016D_ZMu_23Sep2016'
...
config.JobType.pyCfgParams = ['globalTag=80X_dataRun2_2016SeptRepro_v3',
                              'ntupleName=muonPOGNtuple_SingleMuonRun2016D_23Sep2016.root',
                              'hasRaw=True',
                              'nEvents=-1',
                              'runOnMC=False',
                              'hltPathFilter=all',
...
config.Data.inputDataset = '/SingleMuon/Run2016D-ZMu-23Sep2016-v1/RAW-RECO'
