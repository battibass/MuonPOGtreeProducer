...
config.General.requestName = 'SingleMuonRun2017C_ZMu_EOY_ReReco_v2'
...
config.JobType.pyCfgParams = ['globalTag=94X_dataRun2_ReReco_EOY17_v2',
                              'ntupleName=muonPOGNtuple_SingleMuonRun2017C_v2_ReReco.root',
                              'hasRaw=True',
                              'nEvents=-1',
                              'runOnMC=False',
                              'hltPathFilter=all',
...
config.Data.inputDataset = '/SingleMuon/Run2017C-ZMu-17Nov2017-v1/RAW-RECO'
